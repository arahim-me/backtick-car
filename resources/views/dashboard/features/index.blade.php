            ...
            <div class="content-area pt-4 pb-0">
                <main id="main" class="main-content">
                    <div class="tfcl-dashboard">
                        <h1 class="admin-title mb-2">Features</h1>
                                        ...
                                        <div class="tfcl-table-listing">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between p-2">
                                                    <div class="d-flex">
                                                        <span class="result-text"><b>{{ $features->count() }}</b>
                                                            Results
                                                            found</span>
                                                    </div>
                                                        ...
                                                        @forelse ($features as $feature)
                                                            <tr>
                                                                ...
                                                                <td class="column-status">
                                                                    ...
                                                                    <span
                                                                        class="tfcl-listing-status status-publish text-capitalize {{ $feature->status == 'deactive' ? 'text-danger' : '' }}">{{ $feature->status }}</span>

                                                                </td>
                                                                <td class="column-date">
                                                                    <div class="tfcl-listing-date">
                                                                        {{ $feature->created_at->diffForHumans() }}</div>
                                                                </td>
                                                                <td class="column-controller">
                                                                    ...
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="{{ route('dashboard.features.update.status', $feature->id) }}"
                                                                            class="btn-action tfcl-dashboard-action-edit text-capitalize">{{ $feature->status == 'deactive' ? 'active' : 'deactive' }}</a>
                                                                    </div>
                                                                    <div class="inner-controller">
                                                                        <span class="icon">
                                                                        ...
                                                                        <a href="{{ route('dashboard.features.destroy', $feature->id) }}"
                                                                            class="btn-action tfcl-dashboard-action-edit" onclick="return confirm('Are you sure you want to delete this Feature?');">Delete</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @empty
