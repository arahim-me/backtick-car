                                        ...
                                        <div class="form-group">
                                            @if (auth()->user()->image == 'default.png')
                                                <img loading="lazy" class="avatar" decoding="async" width="158" height="138"
                                                    ...
                                                    src="{{ asset('uploads/default') }}/profile.png" alt="avatar" />
                                            @else
                                                <img loading="lazy" class="avatar-preview" decoding="async" width="158" height="138"
                                                    id="update_avatar"
                                                    src="{{ asset('uploads/profiles/') }}/{{ auth()->user()->image }}"
                                                    alt="avatar" />
                                            @endif
