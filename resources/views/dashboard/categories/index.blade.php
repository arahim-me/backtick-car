            ...
            <div class="content-area pt-4 pb-0">
                <main id="main" class="main-content">
                    <div class="tfcl-dashboard">
                        <h1 class="admin-title mb-2">Categories</h1>
                                        ...
                                        <div class="tfcl-table-listing">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between p-2">
                                                    <div class="d-flex">
                                                        <span class="result-text"><b>{{ $categories->count() }}</b>
                                                            Results
                                                            found</span>
                                                    </div>
                                                        ...
                                                        @forelse ($categories as $category)
                                                            <tr>
                                                                ...
                                                                <td class="column-status">
                                                                    ...
                                                                    <span
                                                                        class="tfcl-listing-status status-publish text-capitalize {{ $category->status == 'deactive' ? 'text-danger' : '' }}">{{ $category->status }}</span>
                                                                ...
                                                                <td class="column-controller">
                                                                    ...
                                                                    <a href="{{ route('categories.update.status', [$category->id]) }}"
                                                                        class="btn-action tfcl-dashboard-action-edit text-capitalize"><i
                                                                            class="fa-solid fa-circle-check text-{{ $category->status == 'active' ? 'success' : 'danger' }}"></i></a>
