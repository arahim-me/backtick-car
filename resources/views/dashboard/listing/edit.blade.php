        ...
        <div class="col-md-12">
            <div class="content-area">
                <main id="main" class="main-content">
                    <form class="tfcl-dashboard" action="{{ route('update.listing', $car->id) }}" method="POST"
                        ...
                        <div class="tfcl-add-listing car-details">
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    <label for="type">Car Type: ( <span
                                            class="text-primary text-capitalize">{{ $car->type }}</span> )</label>
                                    <input type="text" class="form-control" name="type"
                                        value="{{ $car->type }}" id="type">
                                    {{-- <div class="nice-select form-control" tabindex="0">
                                    <span class="current">Select</span>
                                    <ul class="list">
                                        <li class="option">Sample Data</li>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="nice-select form-control" tabindex="0" name="condition">
                                        <option class="optoin" value="{{ $car->condition }}"
                                            {{ $car->condition == 'Used' ? 'selected' : '' }}>
                                            Used</option>
                                        <option class="option" value="{{ $car->condition }}"
                                            {{ $car->condition == 'New' ? 'selected' : '' }}>New</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group-4">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="vin_number" placeholder="VIN"
                                        id="vin_number">
                                </div> --}}
                                <div class="form-group">
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <select class="nice-select form-control" name="fuel_type" id="">
                                        <ul class="list">
                                            <span class="current">Select</span>
                                            <li class="option"><option value="">Petrol</option></li>

                                        </ul>
                                    </select> --}}
                                    {{-- <input type="text" class="form-control" name="fuel_type"
                                        placeholder="Fuel Type"id="fuel_type"> --}}
                                    <select class="nice-select form-control" tabindex="0" name="fuel_type">
                                        <option class="optoin" value="Petrol"
                                            {{ $car->fuel_type == 'Petrol' ? 'selected' : '' }}>Petrol</option>
                                        <option class="option" value="LPG"
                                            {{ $car->fuel_type == 'LPG' ? 'selected' : '' }}>LPG</option>
                                        <option class="option" value="Disel"
                                            {{ $car->fuel_type == 'Disel' ? 'selected' : '' }}>Disel</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" class="form-control" name="city_mpg" placeholder="Tyer Size"
                                        id="city_mpg"> --}}
                                    {{-- <div class="nice-select form-control" tabindex="0">
                                    <span class="current">Select</span>
                                    <ul class="list">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea name="description" id="description" placeholder="Car Description">{{ $car->description }}</textarea>
                            </div>
