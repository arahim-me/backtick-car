...
@section('home_content')
    <section class="tf-section3 listing-detail style-1 pt-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="listing-detail-wrap">
                        <div
                            class="swiper mainslider slider home mb-40 swiper-container-fade swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-aae3321f0613674a" aria-live="off"
                                style="transition-duration: 0ms;">
                                @if ($list->image != null)
                                    @foreach (json_decode($list->image) as $images)
                                        <div class="swiper-slide swiper-slide-prev" role="group" {{-- aria-label="1 / 2" --}}
                                            style="width: 830px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                            <div class="image-list-details ">
                                                <a class="image"
                                                    href="{{ asset('uploads/products/images') }}/{{ $images }}"
                                                    data-fancybox="gallery">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('uploads/products/images') }}/{{ $images }}"
                                                        src="{{ asset('uploads/products/images') }}/{{ $images }}"
                                                        alt="image">
                                                </a>
                                ...
                                @else
                                    <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 2"
                                        style="width: 830px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                        <div class="image-list-details ">
                                            <a class="image" href="{{ asset('uploads/default/image-gallery.png') }}"
                                                data-fancybox="gallery">
                                                <img class="lazyload"
                                                    data-src="{{ asset('uploads/default/image-gallery.png') }}"
                                                    src="{{ asset('uploads/default/image-gallery.png') }}" alt="image">
                                            </a>
                                            <div class="specs-features-wrap flex-three">
                                                <a class="specs-features">
                                                    <div class="icon">
                                                ...
                                                <a class="specs-features"
                                                    href="{{ asset('uploads/default/image-gallery.png') }}"
                                                    data-fancybox="gallery">
                                                    <div class="icon">
                                                        <svg width="18" height="14" viewBox="0 0 18 14"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {{-- <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 2"
                                    style="width: 830px; opacity: 0; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                    <div class="image-list-details ">
                                        <a class="image" href="{{ asset('uploads/products') }}/{{ $list->image }}"
                                            data-fancybox="gallery">
                                            <img class="lazyload"
                                                data-src="{{ asset('uploads/products') }}/{{ $list->image }}"
                                                src="{{ asset('uploads/products') }}/{{ $list->image }}" alt="image">
                                        </a>
                                        <div class="specs-features-wrap flex-three">
                                            <a class="specs-features">
                                                <div class="icon">
                                            ...
                                            <a class="specs-features"
                                                href="{{ asset('uploads/products') }}/{{ $list->image }}"
                                                data-fancybox="gallery">
                                                <div class="icon">
                                                    <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="2 / 2"
                                    style="width: 830px; opacity: 1; transform: translate3d(-830px, 0px, 0px); transition-duration: 0ms;">
                                    <div class="image-list-details">
                                        <a class="image" href="{{ asset('uploads/products') }}/{{ $list->image }}"
                                            data-fancybox="gallery">
                                            <img class="lazyload"
                            ...
                            <div class="swiper-button-next style-3 swiper-button-disabled" tabindex="-1" role="button"
                                aria-label="Next slide" aria-controls="swiper-wrapper-aae3321f0613674a"
                                aria-disabled="true"></div>
                            <div class="swiper-button-prev style-3" tabindex="0" role="button"
                                aria-label="Previous slide" aria-controls="swiper-wrapper-aae3321f0613674a"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                                    ...
                                    <div class="listing-description mb-40">
                                        ...
                                        <div class="list-file">
                                            <a target="_blank" href="#" class="button" download="">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#E9EDF4"></path>
                                                    <path
                                                        d="M3.1875 6.19165H7.18015C7.53117 6.19165 7.86781 6.0522 8.11602 5.804C8.36423 5.55579 8.50368 5.21914 8.50368 4.86812V0.879883L3.1875 6.19165Z"
                                                        fill="#D2DBEA"></path>
                                                    <path
                                                ...
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->mileage }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->cylinders }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            <span class="listing-info-title">
                                                                Stock Number:</span>
                                                            <p class="listing-info-value">{{ $list->stock_number }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            <span class="listing-info-title">Fuel
                                                                Type:</span>
                                                            <p class="listing-info-value">{{ $list->fuel_type }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- <div class="col-xl-6 col-md-6 item">
                                                ...
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->doors }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            <span class="listing-info-title">
                                                                Year:</span>
                                                            <p class="listing-info-value">{{ $list->year }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->color }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->seats }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            <span class="listing-info-title">Tyer Type:</span>
                                                            <p class="listing-info-value">{{ $list->tyer_type }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->transmision }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- <div class="col-xl-6 col-md-6 item">
                                                    ...
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            <span class="listing-info-title">Engine
                                                                Size:</span>
                                                            <p class="listing-info-value">{{ $list->engine_size }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- <div class="col-xl-6 col-md-6 item">
                                                ...
                                                <div class="col-xl-6 col-md-6 item">
                                                    <div class="inner listing-infor-box">
                                                        ...
                                                        <div class="content-listing-info">
                                                            ...
                                                            <p class="listing-info-value">{{ $list->driver_type }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="listing-reviews flat-property-detail" id="scrollspyHeading5">
                                        ...
                                        <div class="widget-rating flex-three mb-30 mt-30">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="text-color-2">Base on <span
                                                        class="fw-6">{{ $reviews->count() }}</span></p>
                                            </div>
                                        </div>
                                        <div class="flat-tabs mb-60">
                                            ...
                                            <ul class="menu-tab tab-title flex  ">
                                                ...
                                                <li class="item-title style">
                                                    <span class="inner fs-16 fw-5 lh-20">Mileage</span>
                                                </li>
                                                <li class="item-title style">
                                                    <span class="inner fs-16 fw-5 lh-20">Performance</span>
                                                </li>
                                                <li class="item-title style">
                                                    <span class="inner fs-16 fw-5 lh-20">Safety</span>
                                                </li>
                                                <li class="item-title style">
                                                    <span class="inner fs-16 fw-5 lh-20">Looks</span>
                                                </li>
                                                <li class="item-title style">
                                                ...
                                                <div class="content-inner tab-content" style="">
                                                    <div class="wrap-review  pd-0">
                                                        <div class="titles mb-30">
                                                            <h4>{{ $reviews->count() }} Rating and reviews on this car</h4>
                                                        </div>
                                                        <div class="comment-list">
                                                            <ol class="mb-30">
                                                                @forelse ($reviews as $review)
                                                                    <li>
                                                                        <div class="flex-one">
                                                                            <div class="comment-list-wrap flex-three">
                                                                                <div class="images flex-none">
                                                                                    <img src="{{ asset('uploads') }}/{{ $review->user_id ? 'profiles/' . $review->reviewer->image : 'default/profile.png' }}"
                                                                                        alt="images">
                                                                                </div>
                                                                                <div class="content">
                                                                                    <h5>{{ $review->user_id ? $review->reviewer->name : $review->name }}
                                                                                    </h5>
                                                                                    <div class="icon-star fs-12">
                                                                                        <i
                                                                                            class="icon-autodeal-star {{ $review->rating >= 1 ? 'text-color-3' : '' }}"></i>
                                                                                        <i
                                                                                            class="icon-autodeal-star {{ $review->rating >= 2 ? 'text-color-3' : '' }}"></i>
                                                                                        <i
                                                                                            class="icon-autodeal-star {{ $review->rating >= 3 ? 'text-color-3' : '' }}"></i>
                                                                                        <i
                                                                                            class="icon-autodeal-star {{ $review->rating >= 4 ? 'text-color-3' : '' }}"></i>
                                                                                        <i
                                                                                            class="icon-autodeal-star {{ $review->rating == 5 ? 'text-color-3' : '' }}"></i>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <p class="texts text-color-2">{{ $review->text }}
                                                                        </p>
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                more reviews <i class="icon-autodeal-view-more"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="wrap-contact wrap-form pd-0">
                                            <div class="title">
                                                <h2>Leave a Reply</h2>
                                                <p>{{ auth()->check() ? '' : 'Your email address will not be published!' }}
                                                </p>
                                            </div>
                                            ...
                                            <div id="comments" class="comments">
                                                <div class="respond-comment">
                                                    ...
                                                    <form method="POST" class="comment-form form-submit"
                                                        action="{{ route('review.store') }}" accept-charset="utf-8"
                                                        ...
                                                        @if (!auth()->check())
                                                            <div class="inner-1 form-wg flex">
                                                                ...
                                                                <fieldset class="wg-box ">
                                                                    <label class="fw-6">Email
                                                                        address</label>
                                                                    <input type="email" class="my-input" name="email"
                                                                        placeholder="Your email" required>
                                                                </fieldset>
                                                            </div>
                                                            {{-- <label class="flex checkbox-wrap">
                                                                <input type="checkbox">
                                                        ...
                                                        <input type="text" name="product_id"
                                                            value="{{ $list->id }}" hidden>
                                                        <fieldset class="message-wrap">
                                                            <label class="fw-6">Rate us! (out of 5)</label>
                                                            <div class="rating-input">
                                                                ...
                                                                <input type="reset" name="rating" class="btn">
                                                            </div>
                                                        </fieldset>
                                                        <fieldset class="message-wrap">
                                                            <label class="fw-6">Review</label>
                                                            <textarea id="comment-message" name="text" rows="4" tabindex="4" placeholder="Your Message:" required></textarea>
                                                        </fieldset>
                    ...
                    <div class="listing-sidebar">
                            ...
                            <div class="heading-widget">
                                ...
                                <div class="icon-box flex flex-wrap">
                                    <div class="icons flex-three">
                                        ...
                                        <span class="ms-1">{{ $list->transmision }}</span>
                                    </div>
                                    <div class="icons flex-three">
                                        <i class="icon-autodeal-diesel"></i>
                                        <span class="ms-1">{{ $list->fuel_type }}</span>
                                    </div>
                                    <div class="icons flex-three">
                                        <i class="icon-autodeal-automatic"></i>
                                        <span class="ms-1">{{ $list->driver_type }}</span>
                                    </div>
                                    {{-- <div class="icons flex-three">
                                ...
                                <div class="money text-color-3 font">{{ $list->currency }}{{ $list->price }}
                                </div>
                                {{-- <div class="price-wrap">
                                <p class="fs-12 lh-16 text-color-2">Monthly installment payment: <span class="fs-14 fw-5 font">$4,000</span></p>
                        ...
                        <div class="widget-listing mb-30">
                            <div class="prolile-info flex-three mb-30">
                                <div class="image">
                                    <img class="lazyload"
                                        data-src="{{ asset('uploads') }}/{{ $list->seller->image == 'default.png' ? 'default/profile.png' : 'profiles/' . $list->seller->image }}"
                                        src="{{ asset('uploads') }}/{{ $list->seller->image == 'default.png' ? 'default/profile.png' : 'profiles/' . $list->seller->image }}">
                                </div>
                                <div class="content">
                                    <h4>{{ $list->seller->name }}</h4>
                        ...
                        <div class="list-icon-pf gap-8 flex-three mb-40">
                            ...
                            <div class="listing-recommended mb-30">
                                @foreach ($cars as $car)
                                    <div class="item flex">
                                        ...
                                        <div class="content">
                                            <h6><a
                                                    href="{{ route('listing.details', $car->id) }}">{{ $car->title }}</a>
                                            </h6>
                                            <p class="fs-14 fw-7 text-color-2 font-1">
                                                {{ __('button.currency_icon') }}{{ $car->price }}</p>
                                ...
                                {{-- <div class="item flex">
                                    <div class="image">
                                        <img class="lazyload"
                                            data-src="{{ asset('resources') }}/assets/images/car-list/car34.jpg"
                                            src="{{ asset('resources') }}/assets/images/car-list/car34.jpg"
                                            alt="image">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="item flex">
                                    <div class="image">
                                        <img class="lazyload"
                                            data-src="{{ asset('resources') }}/assets/images/car-list/car29.jpg"
                                            src="{{ asset('resources') }}/assets/images/car-list/car29.jpg"
                                            alt="image">
                                    </div>
                                    <div class="content">
