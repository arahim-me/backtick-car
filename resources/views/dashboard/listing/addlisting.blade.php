                ...
                <main id="main" class="main-content">
                    <form class="tfcl-dashboard" action="{{ route('store.listing') }}" method="POST"
                        ...
                        <div class="tfcl-add-listing">
                            <fieldset class="message-wrap">
                                ...
                                <div class="rating-input">
                                    <input type="radio" id="japanese" name="lang" value="ja" checked /><label
                                        for="japanese" title="japanese">Japanese</label>
                                    <input type="radio" id="english" name="lang" value="en" /><label
                                        for="english" title="english">English</label>
                                    <input type="radio" id="bengali" name="lang" value="bn" /><label
                                        for="bengali" title="bengali">Bengali</label>
                                </div>
                            </fieldset>
                        </div>
                        <div class="tfcl-add-listing upload-photo">
                            <h3>Upload product Thumbnail *</h3>
                            <div class="upload-media choose-box" id="imgInputBox">
                                <div class="inner">
                                    <input type="file" name="thumbnail" id="imgInput" accept="image/*" required
                                        onchange="imageInputPreview('imgInput', 'previewThumbnail', 'imgInputBox')">
                                    <div class="desc mt-3">or drag Thumbnail here <br> <span>(Up to 1 photo only)</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tfcl-add-listing upload-photo">
                            ...
                            <div class="upload-media choose-box" id="imgsInputBox">
                                <div class="inner">
                                    <input type="file" name="image[]" id="upload_images" accept="image/*" multiple
                                        required
                                        onchange="imageInputPreview('upload_images', 'preview_images', 'imgsInputBox')">
                                    <div class="desc mt-3">or drag photos here <br> <span>(Up to 10 photos)</span> </div>
                                </div>
                            </div>
                            <div class="thumbnail-media" id="preview_images_container"
                                style="display: flex; flex-wrap: nowrap; overflow-x: auto; gap: 8px; padding: 8px; background: #f9f9f9; border-radius: 4px; min-height: 120px;">
                                <div class="item" id="previewImagesItem" style="display: flex; gap: 8px; flex-shrink: 0;">
                                    <img src="{{ asset('uploads') }}/default/image-gallery.png" id="preview_images"
                                        class="product_photos" alt="thumb"
                                        style="height: 120px; width: auto; object-fit: cover; border-radius: 4px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tfcl-add-listing car-details">
                            ...
                            <div class="form-group-4">
                                <div class="form-group">
                                    ...
                                    <select class="nice-select form-control" tabindex="0" name="brand_id"
                                        id="brand" required>
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="transmision"
                                        placeholder="Transmission" id="transmision">
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="engine_size"
                                        placeholder="Engine size" id="engine_size">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="tfcl-add-listing car-features">
                            ...
                            <div class="group-features row">
                                @foreach ($features as $key => $feature)
                                    <div class="parent-item group-checkbox col-md-3">
                                        <input id="id{{ $feature->id }}" class="form-check-input" type="checkbox"
                                            name="features[]" value={{ $feature->name }}>
                                        <label for="id{{ $feature->id }}">{{ $feature->name }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        {{-- <div class="tfcl-add-listing car-video">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control" name="video" placeholder="Your video URL"
                                    id="video">
                            </div>
                        </div> --}}
