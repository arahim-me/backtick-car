        ...
        <div class="col-md-12">
            <div class="content-area">
                <main id="main" class="main-content">
                    <form class="tfcl-dashboard" action="{{ route('dashboard.export.store') }}" method="POST"
                        ...
                        <div class="tfcl-add-listing car-details">
                                ...
                                <div class="form-group-2 ms-0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="brand_name"
                                            placeholder="Brand Name" id="brandName">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-group-4">
                                ...
                                <div class="form-group">
                                    <label for="contdition">Condition *</label>

                                    <select class="nice-select form-control" tabindex="0" name="condition">
                                        <option class="optoin" value="Used">Used</option>
                            ...
                            <div class="form-group-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="nice-select form-control" tabindex="0">
                                ...
                                <div class="form-group">
                                    <label for="export_to">Export to (Country)</label>
                                    <input type="text" name="export_to" class="form-control" id="export_to"
                                        placeholder="Export To (Country)">
                                </div>
                                <div class="form-group">
                                    <label for="Importer">Importer Name</label>
                                    <input type="text" class="form-control" name="importer"
                                        placeholder="Importer Name" id="Importer">
                                </div>
                            </div>
                            <div class="form-group-2">
                                <div class="form-group">
                                    <label for="price h-3">Car price</label>
