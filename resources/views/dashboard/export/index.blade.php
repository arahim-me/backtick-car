    ...
    <div class="row">
            ...
            <div class="content-area pt-4 pb-0">
                <main id="main" class="main-content">
                    <div class="tfcl-dashboard">
                        <h1 class="admin-title mb-2">Processing to Export Car</h1>
                                        ...
                                        <div class="tfcl-table-listing">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between p-2">
                                                    <div class="d-flex">
                                                        <span class="result-text"><b>{{ $proc_lists_count->count() }}</b>
                                                            results
                                                            found</span>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        <a href="{{ route('dashboard.export.add') }}"
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody class="tfcl-table-content">
                                                        @forelse ($proc_lists as $list)
                                                            <tr>
                                                                <td class="column-listing">
                                                                    <div class="tfcl-listing-product">
                                                                        <a href="#">
                                                                            @if ($list->image != null)
                                                                                <img src="{{ asset('uploads/products/exports') }}/{{ $list->image }}"
                                                                                    alt="image">
                                                                            @else
                                                                ...
                                                                <td class="column-status">
                                                                    ...
                                                                    <span
                                                                        class="tfcl-listing-status status-publish text-capitalize">{{ $list->status }}</span>
                                                                ...
                                                                <td class="column-controller">
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="{{route('dashboard.export.edit',$list->id)}}"
                                                                    ...
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="#"
                                                                            class="btn-action tfcl-dashboard-action-edit text-capitalize">{{ $list->status }}</a>
                                                                    </div>
                                                                    <div class="inner-controller">
                                                                        <span class="icon">
                                                                        ...
                                                                        <a href="#"
                                                                            class="btn-action tfcl-dashboard-action-edit">Trash</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @empty
        ...
        <div class="col-md-12">
            <div class="content-area pt-4 pb-0">
                <main id="main" class="main-content">
                    <div class="tfcl-dashboard">
                        <h1 class="admin-title mb-2">Already Exported Car</h1>
                                    ...
                                    <div class="tfcl-dashboard-listing">
                                        ...
                                        <div class="tfcl-table-listing">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between p-2">
                                                    <div class="d-flex">
                                                        <span class="result-text"><b>{{ $export_lists_count->count() }}</b>
                                                            results
                                                            found</span>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <tr>
                                                                <td class="column-listing">
                                                                    <div class="tfcl-listing-product">
                                                                        ...
                                                                        <div class="tfcl-listing-summary">
                                                                            <h4 class="tfcl-listing-title">
                                                                                <a target="_blank" href="#">{{$list->title}}</a>
                                                                            </h4>
                                                                            <div class="features-text">
                                                                                {{ $list->description }}
                                                                            </div>
                                                                ...
                                                                <td class="column-controller">
                                                                    ...
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="#"
                                                                            class="btn-action tfcl-dashboard-action-edit">{{ $list->status }}</a>
                                                                    </div>
                                                                    <div class="inner-controller">
                                                                        <span class="icon">
                                                                            <i class="fas fa-trash-arrow-up"></i>
