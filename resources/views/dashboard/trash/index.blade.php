            ...
            <div class="content-area">
                <main id="main" class="main-content">
                    <div class="tfcl-dashboard">
                        <h1 class="admin-title mb-3">Trash listing</h1>
                                                            ...
                                                            <tr>
                                                                <td class="column-listing">
                                                                    <div class="tfcl-listing-product">
                                                                        <a href="{{ route('listing.details', $list->id) }}">
                                                                            @if ($list->image != null)
                                                                                <img src="{{ asset('uploads/products') }}/{{ $list->image }}"
                                                                                    alt="image">
                                                                            @else
                                                                ...
                                                                <td class="column-date">
                                                                    <div class="tfcl-listing-date">
                                                                        {{ $list->updated_at->diffForHumans() }}</div>
                                                                </td>
                                                                <td class="column-controller">
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="{{route('destroy.listing', $list->id)}}"
                                                                            class="btn-action tfcl-dashboard-action-edit" onclick="return confirm('Are you sure you want to Permanently delete this Post?');">Delete</a>
                                                                    </div>
                                                                    ...
                                                                    <div class="inner-controller">
                                                                        ...
                                                                        <a href="{{ route('trash.listing', $list->id) }}"
                                                                            class="btn-action tfcl-dashboard-action-edit">Recycle</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @empty
