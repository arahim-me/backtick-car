                                        ...
                                        <div class="tfcl-table-listing">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between p-2">
                                                    <div class="d-flex">
                                                        <span class="result-text"><b>{{ $orders->count() }}</b>
                                                            Results
                                                            found</span>
                                                    </div>
                                                        ...
                                                        @forelse ($orders as $user)
                                                            <tr>
                                                                <td class="column-listing text-capitalize">
                                                                    <p class="ms-3">{{ $user->name }} Product name</p>
                                                                </td>
                                                                <td class="column-listing">
                                                                    <p class="ms-2">{{ $user->email }} Quantity</p>
                                                                </td>
                                                                <td class="column-listing">
                                                                    <p class="ms-2">{{ $user->quantity }} Customer Name
                                                                    </p>
                                                                </td>
                                                                @if ($user->role->id == 1 || $user->role->id == 2)
                                                                    <td class="column-listing">
                                                                        <p class="ms-2">{{ $user->seller->name }} Seller
                                                                            Name</p>
                                                                    </td>
                                                                @endif
                                                                <td class="column-listing">
                                                                    <div class="olumn-listing text-capitalize">
                                                                        <p class="text-center">
                                                                            {{ $user->created_at->format('d-m-Y') }} Created
                                                                            At</p>
                                                                    </div>
                                                                </td>
                                                                <td class="column-listing">
                                                                    <div class="olumn-listing text-capitalize">
                                                                        <p class="text-center">
                                                                            {{ $user->paymentMethod->name }} Payment Method
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                                <td class="column-listing">
