...
<head>
    <meta charset="utf-8">
    <title>Login || INTEK LLC || A Car Dealer Site || A Trusted Car Seller in Japan || https://intekcar.com
    </title>
    ...
    <div class="login-form py-4"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body space-y-20">
                    <div class="wrap-modal flex">
                        <div class="images flex-none">
                            <img src="{{ asset('resources') }}/assets/images/section/login.jpg" alt="images">
                        </div>
                        <div class="content" style="display: flex; flex-direction: column; justify-content: center;">
                            <h1 class="title-login">Login</h1>
                            <div class="comments">
                                <div class="respond-comment">
                                    <form method="post" class="comment-form form-submit" action="{{ route('login') }}"
                                        accept-charset="utf-8">
                                        @csrf
                                        <fieldset class="">
                                            <label class="fw-6">E-Mail</label>
                            ...
                            <div class="text-box text-center fs-14">Don’t you have an account? <a
                                    href="{{ route('register') }}"
                                    class="font-2 fw-7 fs-14 color-popup text-color-3">Register</a>
                            </div>
