...
@endphp
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="ja-x-mtfrom-en">

<head>
    <meta charset="utf-8">
    <title>@yield('page-title') {{ __('|| INTEK LLC || A Car Dealer Site || A Trusted Car Seller in Japan') }}
        || https://intekcar.com
    </title>
...
<body class="body">
    ...
    <aside class="sidebar-dashboard">
        <div class="db-content db-logo pad-30">
            <a href="{{ route('home') }}" title="INREK LLC">
                <img class="site-logo" src="{{ asset('resources') }}/assets/images/logo/logo.png" alt="Logo"
                    style="width: 120px; height: auto; background: #fff; border-radius: 50%;">
            </a>
        </div>

        <div class="db-content db-author pad-30">
            <h6 class="db-title">Profile</h6>
            <a href={{ route('profile') }} class="author">
                <div class="avatar">
                    <img class="lazyload" loading="lazy" id="tfre_avatar_thumbnail"
                        src="{{ asset('uploads') }}/{{ $user->image ? 'profiles/' . $user->image : 'default/profile.png' }}"
                        alt="admin" title="admin">
                </div>
                <div class="content">
                    <div class="name">{{ __($user->name) }}</div>
                ...
                <div class="db-dashboard-menu">
                    <ul>
                        ...
                        @if ($user->role->name == 'admin' || $user->role->name == 'manager')
                            ...
                            <li>
                                <a href={{ route('users.index') }} class="{{ Route::is('users.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-users"></i>{{ __('Sellers') }}</a>
                            </li>
                            <li>
                                <a href={{ route('users.index') }} class="{{ Route::is('users.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-bullhorn"></i>{{ __('Seller Request') }}</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href={{ route('roles.index') }} class="{{ Route::is('roles.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-people-roof"></i>{{ __('Roles') }}</a>
                            </li>
                            {{-- <li>
                                <a href="{{ route('permissions.index') }}"
                                    class="{{ Route::is('permissions.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-key"></i>{{ __('Permissions') }}</a>
                            </li> --}}
                            <li>
                                <a href="{{ route('brands.index') }}"
                                    class="{{ Route::is('brands.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-car"></i>{{ __('nav.brands') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('models.index') }}"
                                    class="{{ Route::is('models.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-car"></i>{{ __('nav.models') }}</a>
                            </li>
                            <li>
                                <a href={{ route('categories.index') }}
                                    class="{{ Route::is('categories.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-list"></i>{{ __('nav.categories') }}</a>
                            </li>
                            <li>
                            ...
                            {{-- <li>
                                <a href={{ route('dashboard.article.index') }}
                                    class="{{ Route::is('dashboard.article.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-newspaper"></i>{{ __('nav.article') }}</a>
                            </li> --}}
                        @endif
                        <li>
                            <a href={{ route('listing') }} class="{{ Route::is('listing') ? 'active' : '' }}">
                                <i class="fa-solid fa-car"></i>{{ __('nav.my_list') }}</a>
                        </li>
                        <li>
                            <a href={{ route('trash.index') }} class="{{ Route::is('trash.*') ? 'active' : '' }}">
                                <i class="fas fa-trash-arrow-up"></i>{{ __('nav.archived') }}</a>
                        </li>
                        <li>
                            <a href={{ route('messages') }} class="{{ Route::is('messages.*') ? 'active' : '' }}">
                                ...
                                </svg>{{ __('nav.messages') }}<span class="count-page">7</span></a>
                        </li>
                        <li>
                            <a href="{{ route('reviews.index') }}"
                                class="{{ Route::is('reviews.*') ? 'active' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                    viewBox="0 0 22 22" fill="none">
                                    <g opacity="0.2">
                                        <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                ...
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        stroke="#F1FAEE" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <ellipse cx="11.1548" cy="10.8989" rx="2.41648" ry="2.41648"
                                        stroke="#F1FAEE" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </g>
                            </svg>{{ __('nav.change_pass') }}</a>
                    </li>
                    <li>
                        <a class="menu-index-7" href={{ route('logout') }}
                                ...
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="{{ route('home') }}"><img
                                                    src="{{ asset('resources') }}/assets/images/logo/logo.png" alt
                                        ...
                                        <nav class="main-menu show navbar-expand-md">
                                            <div class="navbar-collapse collapse clearfix"
                                                ...
                                                <ul class="navigation clearfix">
                                                    <li class="tf-megamenu current"><a
                                                            href="{{ route('index') }}">{{ __('nav.home') }}</a>
                                                    </li>
                                                    <li class="tfcl-mega-menu"><a
                                                            href="{{ route('listing') }}">{{ __('nav.my_cars') }}</a>
                                                        @if ($user->role == 'admin')
                                                    <li class="tfcl-mega-menu"><a
                                                            href="{{ route('messages') }}">{{ __('nav.my_messages') }}</a>
                                                    </li>
                                                    @endif
                                                    <li class="tfcl-mega-menu"><a
                                                            href="{{ route('exports.index') }}">{{ __('nav.export_cars') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav>
                                    ...
                                    <div class="header-account flex align-center">
                                        <a href="#" class="box-avatar dropdown-toggle"
                                            ...
                                            <div class="avatar avt-40 round">
                                                <img src="{{ asset('uploads') }}/{{ $user->image ? 'profiles/' . $user->image : 'default/profile.png' }}"
                                                    alt="admin" title="admin">
                                            </div>
                                            <p class="name">{{ __($user->name) }}<i class="fas fa-angle-down"></i>
                                            </p>

                                        </a>
                                        <div class="dropdown-menu dashboard-menu">
                                            @if ($user->role == 'admin')
                                                <a class="dropdown-item" href="{{ route('home') }}"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="22"
                                                        height="22" viewBox="0 0 22 22" fill="none">
                                                        <g opacity="0.2">
                                                            <path d="M6.92479 9.35156V15.64" stroke="#F1FAEE"
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M11.2021 6.34375V15.6412" stroke="#F1FAEE"
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M15.4092 12.6758V15.6412" stroke="#F1FAEE"
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                d="M15.4619 1.83398H6.87143C3.87698 1.83398 2 3.95339 2 6.95371V15.0476C2 18.0479 3.86825 20.1673 6.87143 20.1673H15.4619C18.4651 20.1673 20.3333 18.0479 20.3333 15.0476V6.95371C20.3333 3.95339 18.4651 1.83398 15.4619 1.83398Z"
                                            ...
                                            @endif
                                            <a class="dropdown-item" href="{{ route('listing') }}"><i
                                                    class="fa-solid fa-car"
                                                    style="font-size: 20px; margin-right: 10px;"></i>{{ __('nav.my_list') }}</a>

                                            <a class="dropdown-item" href="{{ route('trash.index') }}"><i
                                                    class="fas fa-trash-arrow-up"
                                                    style="font-size: 20px; margin-right: 10px;">
                                                </i>{{ __('nav.archived') }}</a>
                                            <a class="dropdown-item" href="{{ route('dashboard.export.index') }}"><i
                                                    class="fa-solid fa-cloud-arrow-down"
                                                    style="font-size: 20px; margin-right: 10px;">
                                                </i>{{ __('nav.export_cars') }}</a>

                                            <a class="dropdown-item" href="{{ route('favorite.index') }}"><svg
                                                ...
                                                <a class="dropdown-item" href="{{ route('messages') }}"><svg
                                                        ...
                                                        <g opacity="0.2">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                ...
                                                                stroke="#F1FAEE" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                                            <path d="M14.7784 11.3802H14.7867" stroke="#F1FAEE"
                                                                stroke-width="2" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M11.1026 11.3802H11.1109" stroke="#F1FAEE"
                                                                stroke-width="2" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                            <path d="M7.42686 11.3802H7.43511" stroke="#F1FAEE"
                                                                stroke-width="2" stroke-linecap="round"
                                                                stroke-linejoin="round"></path>
                                                        </g>
                                                    </svg>{{ __('nav.messages') }}</a>
                                            @endif
                                            <a class="dropdown-item" href="{{ route('reviews.index') }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                    viewBox="0 0 22 22" fill="none">
                                                    <g opacity="0.2">
                                                        <path
                                            ...
                                            <a class="dropdown-item" href="{{ route('profile') }}"><svg
                                                    ...
                                                    <g opacity="0.2">
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M10.5726 11.0056C12.8992 11.0056 14.7849 9.11897 14.7849 6.79238C14.7849 4.46579 12.8992 2.58008 10.5726 2.58008C8.24599 2.58008 6.3594 4.46579 6.3594 6.79238C6.35154 9.11111 8.22503 10.9977 10.5429 11.0056H10.5726Z"
                                                            stroke="#F1FAEE" stroke-width="1.42857"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </g>
                                                </svg>{{ __('nav.profile') }}</a>
                                            <a class="dropdown-item" href="{{ route('password') }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                    viewBox="0 0 22 22" fill="none">
                                                    <g opacity="0.2">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            stroke="#F1FAEE" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <ellipse cx="11.1548" cy="10.8989" rx="2.41648"
                                                            ry="2.41648" stroke="#F1FAEE" stroke-width="1.5"
                                                ...
                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><svg
                                                    ...
                                                    <g opacity="0.2">
                                                        <path
                                                            ...
                                                            stroke="#F1FAEE" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <path d="M19.4516 11.0208H8.41406" stroke="#F1FAEE"
                                                            stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                        <path d="M16.7656 8.34766L19.4496 11.0197L16.7656 13.6927"
                                                            stroke="#F1FAEE" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </g>
                                                </svg> {{ __('nav.logout') }}</a>
                                        ...
                                        @if ($user->role->name == 'admin' || $user->role->name == 'seller')
                                            <div class="flat-bt-top">
                                                <a class="sc-button" href="{{ route('add.listing') }}">
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="{{ route('home') }}"><img
                                    src="{{ asset('resources') }}/assets/images/logo/logo.png" alt width="197"
                                    height="48"></a></div>
                        <div class="bottom-canvas">
                            <div class="login-box flex align-center">
                                <i class="icon-autodeal-user fs-20"></i>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#popup_bid"
                                    class="fw-7 font-2">{{ __('nav.login') }}</a>
                            </div>
                            <div class="menu-outer"></div>
                            <div class="button-mobi-sell">
                                <a class="sc-button btn-icon center" href="{{ route('add.listing') }}">
    ...
    <script src="{{ asset('resources') }}/app/js/chart.js"></script>
    <script src="{{ asset('resources') }}/app/js/bootstrap.min.js"></script>
    <script src="{{ asset('resources') }}/app/js/main.js"></script>
    <script src="{{ asset('resources') }}/app/js/jquery-ui.js"></script>
    <script src="{{ asset('resources') }}/app/js/dashboard.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/tailwindcss/4.0.0-alpha.10/lib.min.js"></script>
