                    ...
                    <ul>
                        ...
                        @if ($user->role->name == 'admin' || $user->role->name == 'manager')
                            ...
                            <li>
                                <a href="{{ route('brands.index') }}"
                                    ...
                                    <i class="fa-regular fa-flag"></i>{{ __('nav.brands') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('models.index') }}"
                                    class="{{ Route::is('models.*') ? 'active' : '' }}">
                                    <i class="fa-solid fa-hexagon-nodes"></i>{{ __('nav.models') }}</a>
                            </li>
                            <li>
                        ...
                        <li>
                            <a href={{ route('trash.index') }} class="{{ Route::is('trash.*') ? 'active' : '' }}">
                                <i class="fa-regular fa-trash-can"></i>{{ __('nav.archived') }}</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('reviews.index') }}"
                                ...
                                <i class="fa-regular fa-comment"></i>{{ __('nav.my_reviews') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <ul>
                    <li>
                        <a href="{{ route('home') }}" class="{{ Route::is('home') ? 'active' : '' }}">
                            <i class="fa-solid fa-chart-column"></i>{{ __('nav.dashboard') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('favorite.index') }}"
                            class="{{ Route::is('favorite.index') ? 'active' : '' }}">
                            <i class="fa-regular fa-heart"></i>{{ __('nav.my_favorites') }}
                        </a>
                    </li>
                    <li>
                        <a href={{ route('roles.index') }} class="{{ Route::is('roles.*') ? 'active' : '' }}">
                    ...
                    <li>
                        <a class="menu-index-7" href={{ route('logout') }}
                            ...
                            <i class="fa-solid fa-arrow-right-from-bracket"></i>{{ __('nav.logout') }}
                        </a>
                    </li>
                </ul>
            </div>
