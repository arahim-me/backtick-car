...
<body class="body header-fixed">
        ...
        <div id="pagee" class="clearfix">
            ...
            <div class="tf-top-bar style-1">
                <div class="container2">
                    <div class="row">
                        <div class="col-lg-12 flex-one align-items-center">
                            <div class="tf-top-bar-left">
                                <ul class="flex-three">
                                    {{-- <li class="flex-three">
                                        ...
                                        <p class="text-color-1">1933-1, Yoshizawacho, Ota, Gunma 373-0019, Japan </p>
                                    </li> --}}
                                    <li class="flex-three">
                                        <div class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <p class="text-color-1">{{ __('info.hour.regular') }}</p>
                                    </li>
                                    <li class="flex-three">
                                        <div class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <p class="text-color-1"> <a href="tel:0276604005">0276-60-4005</a></p>
                                    </li>
                                </ul>
                            </div>
                            <div class="tf-top-bar-right flex-three">
                                <div class="top-btn">
                                    <a target="_blank" href="https://maps.app.goo.gl/wvP9UUZfvQNrGjMr8"
                                        class="btn btn-warning">{{ __('button.bengal') }}</a>
                                </div>
                                <p class="text-color-1">{{ __('text.to_us.follow') }}:</p>
                                <ul class="flex-three">
                                    <li>
                                    ...
                                    <li>
                                        <a href="https://instagram.com/kur_uma_hanbai"><i
                                                class="fa-brands fa-instagram"></i></a>
                                    </li>
                                    <li>
                                        <a href="http://youtube.com/@INTEKcarhouse"><i
                                                class="fa-brands fa-youtube"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://goo-net.com/usedcar_shop/0404545/detail.html"><img
                                                class="icon" style="width: 15px"
                                                src="{{ asset('resources/assets/icon/goo-net.ico') }}"
                                                alt=""></a>
                                    </li>
                                </ul>
                            </div>
            ...
            <header class="header main-header">
                                ...
                                <div class="inner-container flex justify-space align-center">
                                        ...
                                        <div class="logo">
                                            <a href="/">
                                                <img class="lazyload logo"
                                                    data-src="{{ asset('resources') }}/assets/images/logo/logo.png"
                                                    src="{{ asset('resources') }}/assets/images/logo/logo.png"
                                                    alt="" width="225" height="40"
                                        ...
                                        <nav class="main-menu show navbar-expand-md">
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    <li class="tf-megamenu {{ Route::is('index') ? 'current' : '' }}">
                                                        <a href="{{ route('index') }}">{{ __('nav.home') }}</a>
                                                    </li>
                                                    <li
                                                        class="tfcl-mega-menu {{ Route::is('car.index') ? 'current' : '' }}">
                                                        <a href="{{ route('car.index') }}">{{ __('nav.cars') }}</a>
                                                    </li>
                                                    <li
                                                        class="tfcl-mega-menu {{ Route::is('exports.index') ? 'current' : '' }}">
                                                        <a
                                                            href="{{ route('exports.index') }}">{{ __('nav.export_cars') }}</a>
                                                    </li>
                                                    {{-- <li class="tfcl-mega-menu"><a href="#">About</a>
                                                    </li> --}}
                                                    {{-- <li class="dropdown2">
                                                        <a href="#">Blog</a>
                                                    </li> --}}
                                                    <li
                                                        class="tfcl-mega-menu {{ Route::is('contact.page') ? 'current' : '' }}">
                                                        <a
                                                            href="{{ route('contact.page') }}">{{ __('nav.contact') }}</a>
                                                    </li>
                                                </ul>
                                                <li class="tfcl-mega-menu ms-5">
                                                    <div class="form-group">
                                                        <form action="{{ route('lang.update') }}" method="POST"
                                                            class="form-group row align-items-center flex-nowrap">
                                                            @csrf
                                                            <select name="lang" id="" class="nice-select"
                                                                style="width: fit-content; padding: 10px 20px;">
                                                                <option
                                                                    {{ session('local') == 'ja' ? 'selected' : '' }}
                                                                    class="option" value="ja">日本語</option>
                                                                <option
                                                                    {{ session('local') == 'en' ? 'selected' : '' }}
                                                                    class="option" value="en">English</option>
                                                                <option
                                                                    {{ session('local') == 'bn' ? 'selected' : '' }}
                                                                    class="option" value="bn">বাংলা</option>
                                                            </select>
                                                            <div class="">
                                                                <button type="submit"
                                                                    class="submit-btn btn btn-warning">Change</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="header-account flex align-center">
                                        <div class="search-mobie">
                                            <div role="button"
                                                class="header-search-icon flex items-center justify-center closed">
                                            ...
                                            <div class="wd-find-select">
                                                <form method="get" action="{{ route('search') }}">
                                                    <div class="form-group-1 search-form form-style2 relative">
                                                        <button type="submit" class="d-flex"><i
                                                                class="icon-autodeal-search fs-20"></i></button>
                                        ...
                                        <div class="register">
                                            <ul class="flex align-center">
                                                @if (Auth::check())
                                                    <li class="">
                                                        <a class="d-flex gap-2" href="{{ route('home') }}"><i
                                                                class="icon-autodeal-user fs-20"></i>{{ __('nav.dashboard') }}</a>
                                                    </li>
                                                @else
                                                    <li>
                                            ...
                                            @if (auth()->user()->role == 'admin')
                                                <div class="flat-bt-top">
                                                    <a class="sc-button" href="{{ route('add.listing') }}">
                                                        ...
                                                        <span>{{ __('button.add_listing') }}</span>
                                                    </a>
                                                </div>
                                            @endif
                                        @endif
                ...
                <div style="height: 98px; display: none;"></div>
                <!-- End Header Lower -->
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo logo-box"><a href="{{ route('index') }}">
                                <img class="lazyload logo"
                                    data-src="{{ asset('resources') }}/assets/images/logo/logo.png"
                        ...
                        <div class="bottom-canvas">
                            <div class="login-box flex align-center">
                                @if (auth()->check())
                                    <a href="{{ route('home') }}" class="fw-7 font-2"><i
                                            class="fas fa-user fs-20"></i> Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="fw-7 font-2"><i
                                            class="fas fa-user fs-20"></i>{{ __('nav.login') }}</a>
                                @endif
                            </div>
                            ...
                            <div class="tf-top-bar-left">
                                <ul>
                                    {{-- <li class="flex-three gap-8">
                                        ...
                                        <p class="text-color-2">2972 Westheimer Rd. Santa Ana, Illinois 85486 </p>
                                    </li> --}}
                                    <li class="flex-three gap-8">
                                        <div class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <p class="text-color-2">{{ __('info.hour.regular') }}</p>
                                    </li>
                                    <li class="flex-three gap-8">
                                        <div class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <p class="text-color-2"> <a href="tel:0276604005">0276-60-4005</a></p>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="icon">
                                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                                            ...
                                            <mask id="mask0_4570_8679" style="mask-type:luminance"
                                                ...
                                                <path d="M64.3498 64.35V5.65018H5.65V64.35H64.3498Z"
                                    ...
                                    <div class="icon">
                                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" stroke="#24272C"></path>
                                            <path
                                    ...
                                    <div class="icon">
                                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" stroke="#24272C" stroke-width="0.4"></path>
                                            <path
                                ...
                                <div class="widget widget-menu widget-form footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <form method="post" class="comment-form form-submit" action="#"
                                            ...
                                            <p class="font-2">Stay on top of the latest car trends, tips, and tricks
                                                for
                                                selling your car.</p>
                    ...
                    <div class="footer-bottom">
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-md-12">
                                <div class="logo-footer style box-1 logo-box">
                                    <a href="index.html">
                                        <img class="lazyload logo"
                                            data-src="{{ asset('resources') }}/assets/images/logo/logo.png"
                                            src="{{ asset('resources') }}/assets/images/logo/logo.png" alt="img"
                                            width="225" height="40"
                            ...
                            <div class="col-lg-8 col-md-12 justify-content-center">
                                <div class="footer-bottom-right flex-six flex-wrap ">
                                    <div class="title-bottom center">Copyright © {{ date('Y') }} || INTEK LLC ||
                                        All rights reserved</div>
                                    <div class="icon-social row box-3 text-color-1">
                                        <a href="https://facebook.com/groups/453311246539493"><i
                                                class="fa-brands fa-facebook-f"></i></a>
                                        <a href="https://instagram.com/kur_uma_hanbai"><i
                                                class="fa-brands fa-instagram"></i></a>
    ...
    <div class="container" style="display: flex; justify-content: center; align-items: center; padding: 24px 0;">
                ...
                <div class="choose-box"
                    ...
                    <div class="form-group">
                        <form action="{{ route('lang.update') }}" method="POST"
                            ...
                            <select name="lang" id="" class="nice-select"
                                style="width: fit-content; padding: 10px 20px;">
                                <option {{ session('local') == 'ja' ? 'selected' : '' }} class="option"
                                    value="ja">日本語</option>
                                <option {{ session('local') == 'en' ? 'selected' : '' }} class="option"
                                    value="en">English</option>
                                <option {{ session('local') == 'bn' ? 'selected' : '' }} class="option"
                                    value="bn">বাংলা</option>
                            </select>
                            <div class="">
                                <button type="submit" class="submit-btn">{{ __('button.save_update') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    {{-- <div class="container">
        <h3>{{ __('text.which_lang') }}</h3>
        <div class="row lang-btn-group">
            <a class="btn" href="{{ route('lang.update', 'bn') }}">বাংলা</a>
            <a class="btn" href="{{ route('lang.update', 'en') }}">English</a>
            <a class="btn" href="{{ route('lang.update', 'ja') }}">日本語</a>
        </div>
    </div> --}}
    ...
    {{-- <script>
        const langModal = document.getElementById('staticBackdrop');
        langModal.show(langModal);
    </script> --}}
