                                    ...
                                    <div class="box-tab center flex-two mb-40 flex-wrap gap-20">
                                        <ul class="menu-tab tab-title style1 flex">
                                            <li class="item-title active ">
                                                <h5 class="inner"><a
                                                        href="{{ route('car.index') }}">{{ __('button.all_car') }}</a>
                                                </h5>
                                            </li>
                                            <li class="item-title">
                                                <h5 class="inner"><a
                                                        href="{{ route('query.by.condition', 'new') }}">{{ __('button.new_car') }}</a>
                                                </h5>
                                            </li>
                                            <li class="item-title">
                                                <h5 class="inner "><a
                                                        href="{{ route('query.by.condition', 'used') }}">{{ __('button.used_car') }}</a>
                                                </h5>
                                            </li>
                                        </ul>
