...
@section('home_content')
    <section class="listing-grid tf-section3 pt-4">
        <div class="container2">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-section">
                        <h2>{{ __('10,000+ Get The Best Deals On Used Cars') }}</h2>
                        <p class="mt-20">
                            {{ __('Explore our selection of high-quality, pre-owned vehicles. Our inventory includes top brands like Toyota, Mercedes, Honda, and more. Find the perfect used car for your needs.') }}
                        </p>
                    </div>
                </div>
                <div class="col-lg-12 flex gap-30 text-start">
                    {{-- <div class="sidebar-right-listing">
                                        ...
                                        <div class="widget widget-price ">
                                            <div class="caption flex-two">
                                                <div>
                                                    ...
                                                    <span id="slider-range-value01">{{ __('button.currency_icon') }}
                                                        0</span>
                                                    <span id="slider-range-value02">{{ __('button.currency_icon') }}
                                                        50,000</span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-12 listing-list-car-wrap listing-grid-car-wrap">
                                <div class="flat-tabs themesflat-tabs category-filter">
                                    {{-- <div class="box-tab center flex-two mb-40 flex-wrap gap-20">
                                        <ul class="menu-tab tab-title style1 flex">
                                            <li class="item-title active ">
                                                <h5 class="inner">{{ __('button.all_car') }}</h5>
                                            </li>
                                            <li class="item-title">
                                                <h5 class="inner">{{ __('button.new_car') }}</h5>
                                            </li>
                                            <li class="item-title">
                                                <h5 class="inner ">{{ __('button.used_car') }}</h5>
                                            </li>
                                        </ul>
                                        <div class="box-2 flex gap-8 flex-wrap">
                                                ...
                                                <div class="group-select">
                                                    <div class="nice-select" tabindex="0"><span class="current">Show:
                                                        ...
                                                        <ul class="list style">
                                                            ...
                                                            <li data-value="50" class="option selected focus">
                                                                Show: 50</li>
                                                ...
                                                <div class="group-select">
                                                    <div class="nice-select" tabindex="0"><span class="current">Default
                                                        ...
                                                        <ul class="list style">
                                                            ...
                                                            <li data-value="low-to-high" class="option">Low to
                                                                high</li>
                                                            <li data-value="high-to-low" class="option">High to
                                                                low</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="box-car-list style-2 hv-one">
                                                        <div class="image-group relative ">
                                                            ...
                                                            <ul class="change-heart flex">
                                                                ...
                                                                <li class="box-icon w-32">
                                                                    <a href="{{ route('favorite.store', $car->id) }}"
                                                                        class="icon">
                                                        ...
                                                        <div class="content">
                                                            <div class="inner1">
                                                                ...
                                                                <a href="{{ route('listing.details', $car->id) }}"
                                                                    class="view-car">View
                                                                    details<i class="icon-autodeal-btn-right"></i></a>
                                                            </div>
                                                            <div class="inner2">
                                                                <div class="days-box">
                                                                    ...
                                                                    <p class="fs-12 lh-16">
                                                                        {{ __('View 20 variants matching your search criteria') }}
                                                                    </p>
